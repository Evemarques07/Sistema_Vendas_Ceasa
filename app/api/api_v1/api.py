...
from app.api.api_v1.endpoints import auth, usuario, clientes, produtos, vendas, estoque, relatorios, system

api_router = APIRouter()

api_router.include_router(auth.router, prefix="/auth", tags=["autenticacao"])
api_router.include_router(usuario.router, prefix="/user", tags=["usuarios"])
